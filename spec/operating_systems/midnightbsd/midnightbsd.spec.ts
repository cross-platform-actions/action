import MidnightBsd from '../../../src/operating_systems/midnightbsd/midnightbsd'
...
import * as midnightbsdQemuVm from '../../../src/operating_systems/midnightbsd/qemu_vm'
import {Input} from '../../../src/action/input'

describe('MidnightBSD OperatingSystem', () => {
  ...
  let midnightbsd = new MidnightBsd(architecture, '0.0.0')
  ...
  describe('createVirtualMachine', () => {
    it('creates a virtual machine with the correct configuration', () => {
      let qemuVmSpy = spyOn(midnightbsdQemuVm, 'Vm')

      midnightbsd.createVirtualMachine(
        hypervisorDirectory,
        resourcesDirectory,
        firmwareDirectory,
        input,
