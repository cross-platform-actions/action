...
1. Add the additional provisioning to the `resources/provision.sh` script. Make
    sure to add the additional provisioning to the end of the script, but before
    any minimizing steps. Don't remove any existing steps
